...
@interface SeondIntoPlansController ()<UITableViewDataSource, UITableViewDelegate,NetWorkManagerDelegate>
...
@implementation SeondIntoPlansController
- (void)dealloc {
    self.dataArray = nil;
    self.planDays = nil;
    self.planNodes = nil;
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[SecondTravelViewCell class] forCellReuseIdentifier:@"CHU"];
    dispatch_queue_t queue1 = dispatch_get_main_queue();
    dispatch_async(queue1, ^{
        
        [[NetWorkManager shareWithManager] getDataWithURL:[NSString stringWithFormat:@"https://chanyouji.com/api/plans/%@.json?page=1",self.strID] Method:@"GET" Parameters:nil Kind:0 OrContainChinese:NO success:^(id obj) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SecondTravelViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CHU" forIndexPath:indexPath];
