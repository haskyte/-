//
//  SeconDestinationViewController.m
//  ChanYouJi
//
...
@interface SeconDestinationViewController ()<UITableViewDataSource, UITableViewDelegate, NetWorkManagerDelegate>
...
@implementation SeconDestinationViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[ThirdTravelViewCell class] forCellReuseIdentifier:@"CHU"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ThirdTravelViewCell *cell = [[ThirdTravelViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"CHU"];
    /*未完待续*/
