...
#import "ThirdIntoPlansController.h"
...
@interface ThirdIntoPlansController ()<UITableViewDataSource, UITableViewDelegate, NetWorkManagerDelegate>
...
@implementation ThirdIntoPlansController
- (void)dealloc {
    self.tableView = nil;
    self.dataArray = nil;
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[ThirdTravelViewCell class] forCellReuseIdentifier:@"KING"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ThirdTravelViewCell *cell = [[ThirdTravelViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"KING"];
    /*未完待续*/
