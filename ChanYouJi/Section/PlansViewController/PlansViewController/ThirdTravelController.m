...
@interface ThirdTravelController ()<UITableViewDataSource, UITableViewDelegate, NetWorkManagerDelegate>
...
@property (nonatomic, retain)NSMutableArray *arrayPhoto_url;
@property (nonatomic, retain)NSMutableDictionary *dic;
@end

@implementation ThirdTravelController
- (void)dealloc {
    self.tableView = nil;
    self.dataArray = nil;
...
- (NSMutableArray *)arrayPhoto_url {
    if (!_arrayPhoto_url) {
        self.arrayPhoto_url = [NSMutableArray array];
    }
    return _arrayPhoto_url;
}
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[ThirdTravelViewCell class] forCellReuseIdentifier:@"cell"];
...
//            [fourth.indexArray addObjectsFromArray:self.strName];
...
//                
//                [self.arrayPhoto_url addObject:fourth.photo_url];//gg
//                
//                fourth.countNumber = arrayNotes.count;
//                [fourth.array_photoUrl addObjectsFromArray:self.arrayPhoto_url];
                [self.dataArray addObject:fourth];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ThirdTravelViewCell *cell = [[ThirdTravelViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"cell"];
    /*未完待续*/
